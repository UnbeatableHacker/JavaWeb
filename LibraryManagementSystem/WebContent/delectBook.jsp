...
<section class="publicMian">
	...
	<div class="right">
		...
		<div class="providerAdd">
			<form id="" name="" method="post" action="delectBook.do"> 
				<div class="">
					<label for="bookId">图书编号：</label>
					<input type="text" class="text" name="bookId" id="bookId" value="">
					<font color="red"></font>
				</div>
				<div class="">
					<label for="admId">管理员编号：</label>
					<input type="text" class="text" name="admId" id="admId" value="">
					<font color="red"></font>
				</div>
				<div class="">
				...
				<div class="providerAddBtn">
					<input type="submit" name="delectBook" id="delectBook" value="删除">
				</div>
			</form>
		<!-- 右侧结束 -->
		</div>
